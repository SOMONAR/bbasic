              ...
              <#if userLogin?has_content>
                  <li><#-- Primary Applications -->
                      <div class="navbar-btn">
                          ...
                          <span class="glyphicon glyphicon-cog button-label"></span>
                            ${uiLabelMap.CommonApplications}
                          </button>
                ...
                <li class="dropdown"><#-- Secondary Applications -->
                    <div class="navbar-btn">
                          <button class="btn btn-default" dropdown-toggle" data-toggle="dropdown" type="button" aria-expanded="false">
                            <span class="glyphicon glyphicon-plus button-label"></span>
              ...
              <#if userLogin?exists>
                  ...
                  <#if userLogin.partyId?exists>
                    <li>
                        <div class="navbar-btn">
                              <button class="btn btn-default" dropdown-toggle" data-toggle="dropdown" type="button" aria-expanded="false">
                                <span class="glyphicon glyphicon-user button-label"></span>${userName}
                            </button>
                            <ul class="dropdown-menu" role="menu">
                                <li>
                                <a href="<@ofbizUrl>passwordChange</@ofbizUrl><span class="glyphicon glyphicon-lock button-label">${uiLabelMap.CommonChangePassword}</a>
                                </li>
                                <li>
                                <a href="<@ofbizUrl>ListVisualThemes</@ofbizUrl>"><span class="glyphicon glyphicon-list button-label"></span> ${uiLabelMap.CommonVisualThemes}</a>
                                </li>
                                <li>
                                    <a href="<@ofbizUrl>ListLocales</@ofbizUrl>"><span class="glyphicon glyphicon-globe button-label"></span> ${uiLabelMap.CommonLanguageTitle}</a>
                                </li>
                            </ul>
